...
class EnfantsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create enfant" do
    assert_difference("Enfant.count") do
      post enfants_url, params: { enfant: { birth: @enfant.birth, prenom: @enfant.prenom, user_id: @enfant.user_id } }
    end
  ...
  test "should update enfant" do
    patch enfant_url(@enfant), params: { enfant: { birth: @enfant.birth, prenom: @enfant.prenom, user_id: @enfant.user_id } }
